	...
	export module game {
		export class Actuator extends egret.HashObject {
			...
			public constructor(game:com.game.Game)
			{
				...
				com.common.DispatcherHandler.instance.addEventListener(com.common.KeyUtil.DISAVTIVITY,this.onPass.bind(this),null);
				com.common.DispatcherHandler.instance.addEventListener(com.common.KeyUtil.AVTIVITY,this.onActivity.bind(this),null);
				this._game.stage.addEventListener(egret.Event.ENTER_FRAME,this.onFrame,this);
			}
			...
			public actuate(grid:com.game.Grid,metadata:any)
			{
				...
				{
					var column:Array<com.game.Tile> = args[0];
					column.forEach(function (...args)
					{
						var cell:com.game.Tile = args[0];
						if(cell)
						{
			...
			public getTileSkin(value:number):Array<any>
			{
				...
				var idx:number = (typeEnumArr.indexOf(value));
