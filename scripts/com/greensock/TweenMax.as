package com.greensock
{
   ...
   public class TweenMax extends TweenLite implements IEventDispatcher
   {
      ...
      public static const version:Number = 11.697;
      ...
      public function TweenMax(target:Object, duration:Number, vars:Object)
      {
         ...
         _repeatDelay = Boolean(this.vars.repeatDelay)?Number(Number(this.vars.repeatDelay)):Number(0);
      ...
      {
         return _dispatcher == null?Boolean(false):Boolean(_dispatcher.dispatchEvent(e));
      }
      ...
      {
         return _dispatcher == null?Boolean(false):Boolean(_dispatcher.willTrigger(type));
      }
      
      public function hasEventListener(type:String) : Boolean
      {
         return _dispatcher == null?Boolean(false):Boolean(_dispatcher.hasEventListener(type));
      }
      ...
      override public function invalidate() : void
      {
         ...
         _repeat = Boolean(this.vars.repeat)?int(Number(this.vars.repeat)):int(0);
         _repeatDelay = Boolean(this.vars.repeatDelay)?Number(Number(this.vars.repeatDelay)):Number(0);
